#!/bin/sh
# export AWS_CREDENTIALS=`aws sts assume-role --role-arn arn:aws:iam::217912576673:role/assumerole --role-session-name --profile Himaja "$(curl 169.254.169.254/latest/meta-data/instance-id)-$(date +%s)" --output text`
